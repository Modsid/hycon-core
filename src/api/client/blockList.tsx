...
<span className="jss337">
   ...
   <div className="jss256 jss259 jss257 jss468 jss406 jss467"><div className="jss466"><h1 className="jss313 jss319">Latest Price</h1></div><div className="jss465"><div className="jss361"><div className="jss369 jss362 jss365"><span className="jss3781">  {price_hyc.map(price=><div key={price.ticker.last}> {price.ticker.last} Sats </div>)} </span></div></div></div></div>
